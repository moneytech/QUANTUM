// =============================================================================
// <integer/convert/hexadecimal/serialize/format/intro.c>
//
...
// Prefix
size_t prfx = (flags & int_format_prefix) & (!uv - 1u);
size += prfx;
...
// Case
uint lc = (flags & int_format_lcase);
...
// Write the prefix
  ...
  {
    buf[just + sign] = '0';
    buf[just + sign + 1u] = 'X' | lc;
  }

// Write the hexadecimal digit characters
ptr -= len;
